...
public class CrystalInfuserScreen extends AbstractContainerScreen<CrystalInfuserMenu> {
	...
	public CrystalInfuserScreen(CrystalInfuserMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("metacrystals:textures/screens/crystal_infuser.png");
