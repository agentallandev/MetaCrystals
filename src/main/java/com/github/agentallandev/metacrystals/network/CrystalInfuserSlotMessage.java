...
public class CrystalInfuserSlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public CrystalInfuserSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public CrystalInfuserSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(CrystalInfuserSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(CrystalInfuserSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		MetacrystalsMod.addNetworkMessage(CrystalInfuserSlotMessage.class, CrystalInfuserSlotMessage::buffer, CrystalInfuserSlotMessage::new,
				CrystalInfuserSlotMessage::handler);
	}
}
