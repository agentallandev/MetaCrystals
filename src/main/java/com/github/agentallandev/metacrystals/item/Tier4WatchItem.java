...
import com.github.agentallandev.metacrystals.procedures.Tier4WatchEffectsProcedure;
...
public class Tier4WatchItem extends Item {
	public Tier4WatchItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openGui(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return new TextComponent("Tier 4 Crystal Watch");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new Tier4WatchGUIMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		Tier4WatchEffectsProcedure.execute(entity);
	}

	@Override
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new Tier4WatchInventoryCapability();
	}
