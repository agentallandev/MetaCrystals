...
public class Tier3WatchEffectsProcedure {
	public static void execute(Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == MetacrystalsModItems.TIER_3_WATCH
				.get()) {
			if (MetacrystalsModItems.HASTE_CRYSTAL.get() == (new Object() {
				...
				.getItem() == MetacrystalsModItems.TIER_3_WATCH.get()) {
			if (MetacrystalsModItems.HASTE_CRYSTAL.get() == (new Object() {
				public ItemStack getItemStack(int sltid, ItemStack _isc) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					_isc.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
