...
public class Tier3WatchGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Tier3WatchGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MetacrystalsModMenus.TIER_3_WATCH_GUI, id);
