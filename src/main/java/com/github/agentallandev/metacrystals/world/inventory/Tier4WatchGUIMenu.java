...
public class Tier4WatchGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Tier4WatchGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MetacrystalsModMenus.TIER_4_WATCH_GUI, id);
