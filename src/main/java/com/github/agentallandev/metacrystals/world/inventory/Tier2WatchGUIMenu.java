...
public class Tier2WatchGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Tier2WatchGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MetacrystalsModMenus.TIER_2_WATCH_GUI, id);
