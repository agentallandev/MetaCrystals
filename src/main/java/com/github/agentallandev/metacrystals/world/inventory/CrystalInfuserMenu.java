...
public class CrystalInfuserMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CrystalInfuserMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MetacrystalsModMenus.CRYSTAL_INFUSER, id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			MetacrystalsMod.PACKET_HANDLER.sendToServer(new CrystalInfuserSlotMessage(slotid, x, y, z, ctype, meta));
			CrystalInfuserSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof CrystalInfuserMenu) {
